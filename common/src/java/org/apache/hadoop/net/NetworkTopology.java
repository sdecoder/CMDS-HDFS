...
public class NetworkTopology {
	...
	private class InnerNode extends NodeBase {
		...
		boolean isAncestor(Node n) {
			return getPath(this).equals(NodeBase.PATH_SEPARATOR_STR) || (n.getNetworkLocation() + NodeBase.PATH_SEPARATOR_STR).startsWith(getPath(this) + NodeBase.PATH_SEPARATOR_STR);
		}
	...
	/**
	 * Remove a node Update node counter & rack counter if necessary
	 * 
	 * @param node
	 *            node to be removed
	 */
	 ...
	 * found, put a random replica location at position 0. It leaves the rest
	 * nodes untouched.
	 */
