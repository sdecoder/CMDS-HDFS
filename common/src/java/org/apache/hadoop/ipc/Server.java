...
public abstract class Server {
  ...
  //add by wangyouwei
  public synchronized void pendingServices() throws InterruptedException{
  	synchronized (handlers) {
  		for (Handler _handle : handlers) {
				_handle.wait();
			}
		}
  ...
  public synchronized void resumeServices() throws InterruptedException{
  	synchronized (handlers) {
  		for (Handler _handle : handlers) {
