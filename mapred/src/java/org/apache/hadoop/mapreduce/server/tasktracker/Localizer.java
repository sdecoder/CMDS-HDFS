...
public class Localizer {
	...
	public static class PermissionsHandler {
		 ...
		 * path. Using this, one can set all possible combinations of
		 * permissions for the owner of the file. But permissions for the group
		 * and all others can only be set together, i.e. permissions for group
		 * cannot be set different from those for others and vice versa.
		 */
		@InterfaceAudience.Private
		@InterfaceStability.Unstable
