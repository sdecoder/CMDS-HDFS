...
public class TestInjectionForSimulatedStorage extends TestCase {
  ...
  public void testInjection() throws IOException {
    ...
    try {
      ...
      waitForBlockReplication(testFile, dfsClient.getNamenode().getNN(testFile), numDataNodes, 20);
      ...
      waitForBlockReplication(testFile, dfsClient.getNamenode().getNN(testFile), numDataNodes, -1);
