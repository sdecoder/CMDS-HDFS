...
public class TestFileAppend3 extends junit.framework.TestCase {
  ...
  public void testTC7() throws Exception {
    ...
    final LocatedBlocks locatedblocks = fs.dfs.getNamenode().getNN(p.toString()).getBlockLocations(p.toString(), 0L, len1);
  ...
  public void testTC11() throws Exception {
    ...
    final LocatedBlocks locatedblocks = fs.dfs.getNamenode().getNN(pnew.toString()).getBlockLocations(pnew.toString(), 0L, len);
