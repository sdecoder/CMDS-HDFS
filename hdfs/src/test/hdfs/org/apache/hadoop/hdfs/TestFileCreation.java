...
public class TestFileCreation extends junit.framework.TestCase {
  ...
  public void testFileCreationError1() throws IOException {
    ...
    try {
      ...
      LocatedBlocks locations = client.getNamenode().getNN(file1.toString()).getBlockLocations(
  ...
  public void testFileCreationError2() throws IOException {
    ...
    try {
      ...
      LocatedBlock location = client.getNamenode().getNN(file1.toString()).addBlock(file1.toString(), 
          client.clientName, null, null);
      System.out.println("testFileCreationError2: "
          + "Added block " + location.getBlock());

      locations = client.getNamenode().getNN(file1.toString()).getBlockLocations(file1.toString(), 
                                                    0, Long.MAX_VALUE);
  ...
  public void xxxtestFileCreationNamenodeRestart() throws IOException {
    ...
    try {
      ...
      locations = client.getNamenode().getNN(file1.toString()).getBlockLocations(
 ...
 */
  ...
  public void testLeaseExpireHardLimit() throws Exception {
    ...
    try {
      ...
      LocatedBlocks locations = dfs.dfs.getNamenode().getNN(f).getBlockLocations(
          f, 0, Long.MAX_VALUE);
