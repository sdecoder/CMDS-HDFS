...
public class DFSConfigKeys extends CommonConfigurationKeys {
  ...
  public static final String  DFS_POOLNODE_IPC_ADDRESS = "dfs.poolnode.ipc.address";
  public static final String  DFS_POOLNODE_ADDRESS = "dfs.poolnode.address"; 
  //Keys for Clover DNN
  public static final String  	DFS_DNN_LIST_KEY = "dfs.dnn.list";
  public static final String  	DFS_DNN_NAMESPACE_SEED = "dfs.dnn.namespace.seed";
  public static final String  	PROTOCOL_BUFFER_SOCKET_RPC_PORT = "protocol.buffer.socket.rpc.port";
  public static final String  	THRIFT_SERVER_RPC_PORT = "thrift.server.rpc.port";
  public static final int 	GDT_SERVER_IDX = 0;
  public static final String 	new_line = "\n";
  public static final String	COMMIT_STRING = "commit";
  public static final String	ABORT_STRING = "abort";
  
  public enum FSOperations {  
	  //solo operations
	  GET_UID, //0
	  CREATE_UID,//1
	 // DELETE_UID,//2
	  ...
	  GET_BLOCK_SIZE, //4
	  GET_SERVER_DEFAULTS, //5
	  GET_DELEGATION_TOKEN, //6
	  
	  RENEW_DELEGATION_TOKEN, // 7
	  CANCEL_DELEGATION_TOKEN, //8
	  REPORT_BAD_BLOCKS, // 9
	  CREATE_SYMLINK, //10
	  ...
	  GET_FILELINKINFO,
	  GET_DISKSTATUS,
	  GET_MISSINGBLOCKSCOUNT,
	  GET_UNDERREPLICATEDBLOCKSCOUNT,
	  GET_CORRUPTBLOCKSCOUNT,
	  CALL_GET_BLOCKLOCATIONS,
	  DATANODEREPORT,
	  ...
	  DUMP_NAMESPACE,
	  SAVE_NAMESPACE,
	  RESTORE_FAILEDSTORAGE,
	  REFRESH_NODES,
	  METASAVE,
	  FINALIZE_UPGRADE,
	  DISTRIBUTED_UPGRADEPROGRESS,
	  UPDATE_BLOCKFORPIPELINE,
	  UPDATE_PIPELINE,
	  ABANDON_BLOCK,
	  ADD_BLOCK,
	  RENEW_LEASE,
