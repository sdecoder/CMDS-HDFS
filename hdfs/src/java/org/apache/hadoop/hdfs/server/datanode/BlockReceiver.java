      ...
      if (!checksum.compare(checksumBuf, checksumOff)) {
        if (srcDataNode != null) {
          try {
            ...
            datanode.__namenode.reportBadBlocks(new LocatedBlock[] {lb});
          } catch (IOException e) {
            ...
            if (lastPacketInBlock) {
              ...
              if (ClientTraceLog.isInfoEnabled() &&
                ...
                ClientTraceLog.info(String.format(DN_CLIENTTRACE_FORMAT,
                      ...
                      datanode.dnRegistration.get(datanode.namenode.getNNIndex(block.getBlockId())).getStorageID(), block, endTime-startTime));
              } else {
